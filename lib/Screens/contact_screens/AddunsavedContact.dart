...
import 'package:wloop/Screens/chat_screen/lazyLoadingChat.dart';
        ...
        setState(() {
          ...
          if (isUser!) {
            if (OnlyPeerWhoAreSavedInmyContactCanMessageOrCallMe == true) {
              if (user.data()!.containsKey(Dbkeys.deviceSavedLeads)) {
                if (user
                    .data()![Dbkeys.deviceSavedLeads]
